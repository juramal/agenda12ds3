...
<div class="w3-display-middle" style="width: 30%;">
    ...
    <!-- Formulário SEPARADO para Administrador -->
    <form action="Controller/navegacao.php" method="post" class="w3-container w3-center">
        <div class="w3-row w3-section">
            <button name="btnADM" class="w3-button w3-green w3-round-large" style="width: 45%;">Administrador</button>
        </div>
    </form>
</div>
